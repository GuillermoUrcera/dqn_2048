...
with tf.variable_scope("critic"):
    h1=tf.layers.dense(state_input_tensor,256,activation=tf.nn.relu,name="hidden_layer_1",reuse=False)
    h2=tf.layers.dense(h1,256,activation=tf.nn.relu,name="hidden_layer_2",reuse=False)
    h3=tf.layers.dense(h2,100,activation=tf.nn.relu,name="hidden_layer_3",reuse=False)
...
with tf.variable_scope("target_critic"):
    h1_target=tf.layers.dense(state_input_tensor,256,activation=tf.nn.relu,name="hidden_layer_1",reuse=False)
    h2_target=tf.layers.dense(h1_target,256,activation=tf.nn.relu,name="hidden_layer_2",reuse=False)
    h3_target=tf.layers.dense(h2_target,100,activation=tf.nn.relu,name="hidden_layer_3",reuse=False)
